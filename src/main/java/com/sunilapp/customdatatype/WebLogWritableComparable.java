...
public class WebLogWritableComparable implements WritableComparable<WebLogWritableComparable> {

	private Text siteURL, reqDate, timestamp, ipaddress;
	private IntWritable reqNo;

	// Default Constructor
	public WebLogWritableComparable() {
	...
	// Custom Constructor
	public WebLogWritableComparable(IntWritable reqno, Text url, Text rdate, Text rtime, Text rip) {
		this.siteURL = url;
		this.reqDate = rdate;
	...
	@Override
	public int compareTo(WebLogWritableComparable o) {
	...
	public boolean equals(Object o) {
		if (o instanceof WebLogWritableComparable) {
			WebLogWritableComparable other = (WebLogWritableComparable) o;
